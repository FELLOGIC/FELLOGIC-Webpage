      ...
      <Card className="w-full max-w-md relative z-10 bg-card border-border">
        <CardHeader className="text-center pb-2 pt-8">
          <div className="flex justify-center mb-6">
            <FellogicLogo size="large" />
          </div>
          <p className="text-muted-foreground text-sm">Enterprise Automation Portal</p>
        </CardHeader>
        <CardContent className="space-y-4 px-8">
          <Button
            variant="outline"
            className="w-full h-11 gap-3 text-sm border-border hover:bg-accent"
          ...
          <div className="space-y-3">
            <div className="space-y-1.5">
              ...
              <Input id="email" type="email" placeholder="you@company.com" className="h-10 bg-secondary" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="password" className="text-xs text-muted-foreground">Password</Label>
              <Input id="password" type="password" placeholder="••••••••" className="h-10 bg-secondary" />
            </div>
          </div>

          <Button className="w-full h-10" onClick={() => navigate("/dashboard")}>
            Sign In
          </Button>
        </CardContent>
