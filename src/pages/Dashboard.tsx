import { Activity, ArrowRight, CheckCircle2, Clock, XCircle, Zap } from "lucide-react";
...
const recentJobs: Array<{ id: string; name: string; status: JobStatus; time: string }> = [
  { id: "JOB-1247", name: "Bulk User Upload", status: "Running", time: "2 min ago" },
  { id: "JOB-1246", name: "Planview Job Stream Report", status: "Completed", time: "15 min ago" },
  { id: "JOB-1245", name: "Create User", status: "Completed", time: "1 hr ago" },
  { id: "JOB-1244", name: "Portfolio Report", status: "Failed", time: "2 hr ago" },
  { id: "JOB-1243", name: "Update User", status: "Completed", time: "3 hr ago" },
];
